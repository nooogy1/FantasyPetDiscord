...
class FilterHandler {
  ...
  async getPetCountWithFilters(filterData) {
    ...
    // Age group filter - handles various formats like "1 year old", "1 year, 1 month old"
    if (filterData.ageGroup) {
      query += ` AND (
        CASE
          WHEN ${paramCount} = 'puppy' THEN (
