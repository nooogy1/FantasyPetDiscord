    ...
    if (filterData.ageGroup) {
      if (filterData.ageGroup === 'puppy') {
        ...
        query += ` AND (
          ...
          AND NOT (p.age ILIKE '%7 year%' OR p.age ILIKE '%8 year%' OR p.age ILIKE '%9 year%' OR p.age ILIKE '%10%')
        )`;
      } else if (filterData.ageGroup === 'senior') {
        query += ` AND (
          p.age ILIKE '%7 year%' OR p.age ILIKE '%8 year%' OR p.age ILIKE '%9 year%' OR p.age ILIKE '%10%' OR p.age ILIKE '%11%' OR p.age ILIKE '%12%'
        )`;
      }
    }
